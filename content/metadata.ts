...
export const postsMetadata: Record<string, BlogMetadata> = {
  ...
  'sfbt-practical-guide-youth-counseling-techniques': {
    ...
    date: '2025-05-18',
    excerpt: '這兩個月我參加了陳意文老師的SFBT（焦點解決短期治療）兒童青少年輔導研習，學習如何從問題分析轉為解決導向，透過例外探索、奇蹟問句和評量問句等技巧，幫助孩子找到自己的能力與資源。本文分享學習心得、真實案例和生活應用，探討如何在助人工作中看見希望之光。',
    author: 'Ian Chou',
    tags: ['SFBT', '焦點解決', '兒童輔導', '青少年輔導', '心理諮商', '教育'],
    coverImage: '/images/posts/sfbt-practical-guide-youth-counseling-techniques.webp'
  },
  'cursor-ai-12-best-practices': {
    title: '掌握 Cursor AI 開發：首席設計師 Ryo Lu 的 12 項關鍵技巧，從此告別混亂程式碼',
    date: '2025-05-18',
    excerpt: '深入解析 Cursor 首席設計師 Ryo Lu 提出的 12 條正確使用方法，從專案規則設定、提示詞精準表達到測試驅動開發，全面提升 AI 輔助程式設計效率。本文附帶豐富實例，幫助開發者避免「AI 義大利麵條程式碼」，打造快速、乾淨的高品質代碼。',
    author: 'Ian Chou',
    tags: ['Cursor', 'AI', '程式開發', '開發工具', '最佳實踐', 'AI 輔助開發', 'Claude', 'Gemini'],
    coverImage: '/images/posts/cursor-ai-12-best-practices.webp'
  },

  'ai-anxiety-syndrome-survival-guide': {
    title: '當「An apple a day」變成「An AI a day」：解鎖AI焦慮症時代的生存指南',
    date: '2025-05-16',
    excerpt: '探討人工智能技術風行下的「AI焦慮症」現象，從就業安全、隱私疑慮到信息真實性三大焦慮誘因分析，並提供知識武裝、終身學習等五大自我調適策略。透過真實案例和數據，幫助讀者在AI時代找到心理平衡點，成為AI的主人而非俘虜。',
    author: 'Ian Chou',
    tags: ['AI', '心理健康', '職場轉型', '科技焦慮', '自我成長'],
    coverImage: '/images/posts/ai-anxiety-syndrome-survival-guide.webp'
  },
  ...
  'windsurf-swe1-model-family': {
    title: 'Windsurf SWE-1 模型家族：重新定義 AI 輔助軟體工程的邊界',
    date: '2025-05-16',
    excerpt: 'Windsurf 推出專為軟體工程設計的 SWE-1 模型家族，以流感知（Flow Awareness）為核心，覆蓋軟體開發全生命週期，與 Claude 3.7 和 GPT-4.1 競爭。深入分析這場改變開發者工作流程的技術革命。',
    author: 'Ian Chou',
    tags: ['AI', '軟體開發', 'Windsurf', 'SWE-1', '程式輔助工具', 'Claude', 'GPT-4.1', '程式生成', '流感知', '開發者工具'],
    coverImage: '/images/posts/windsurf-swe1-model-family.webp'
  },
  ...
  'product-logic-shift-ai': {
    ...
    coverImage: '/images/posts/product-logic-shift-ai.webp'
  },
  'openmemory-personal-memory-layer': {
    ...
    coverImage: '/images/posts/openmemory-personal-memory-layer.webp'
  },
  ...
  'ai-prd-devops-integration-guide-2025': {
    title: 'AI 驅動 PRD - DevOps 整合指南：從需求洞察到自動化部署的全過程',
    date: '2025-05-15',
    excerpt: '本文深入研究 AI（人工智慧）如何與 PRD（產品需求文件）及 DevOps 深度融合，開創軟體工程的全新模式。從需求洞察智能化到自動化部署，分享 AI + PRD + DevOps 的實戰應用與最佳實踐。',
    author: 'Ian Chou',
    tags: ['AI', 'PRD', 'DevOps', '軟體工程', '自動化', '智能化'],
    coverImage: '/images/posts/ai-prd-devops-integration-guide-2025.webp'
  },
  ...
  '2025-freelancer-guide-low-code-no-code-development-applications-ranking': {
    ...
    coverImage: '/images/posts/2025-freelancer-guide-low-code-no-code-development-applications-ranking.webp'
  },
  ...
  'Vercel-Blog-Starter-Kit--TinaCMS': {
    ...
    coverImage: '/images/posts/Vercel-Blog-Starter-Kit--TinaCMS.webp'
  },
  'low-code-no-code-market-trends-2025-career-transition': {
    ...
    author: 'Ian Chou',
    tags: ['Low-Code', 'No-Code', 'Market Trends', 'Career Transition', 'AI', 'Entrepreneurship'],
    coverImage: '/images/posts/low-code-no-code-market-trends-2025-career-transition.webp'
  },
  ...
  'static-website-architecture-breakthrough-abandoning-page-bundle-for-react-ecosystem': {
    ...
    coverImage: '/images/posts/static-website-architecture-breakthrough-abandoning-page-bundle-for-react-ecosystem.webp'
  },
  ...
  'vercel-blog-setup-experience': {
    ...
    coverImage: '/images/posts/vercel-blog-setup-experience.webp'
  },
  ...
  'comparing-cms-platforms-wispcms-tinacms-mdx-support-analysis': {
    ...
    coverImage: '/images/posts/comparing-cms-platforms-wispcms-tinacms-mdx-support-analysis.webp'
  },
  ...
  'fullstack-development-adventure-mdx-cloud-deployment-ai-workflow-experience': {
    ...
    coverImage: '/images/posts/fullstack-development-adventure-mdx-cloud-deployment-ai-workflow-experience.webp'
  },
  ...
  'blog-exploring-react-workflow-contentlayer-tinacms': {
    ...
    coverImage: '/images/posts/blog-exploring-react-workflow-contentlayer-tinacms.webp'
  },
  ...
  'cms-journey-tinacms-to-wispcms-mdx': {
    ...
    coverImage: '/images/posts/cms-journey-tinacms-to-wispcms-mdx.webp'
  },
  ...
  'automating-deployment-docusaurus-github-vercel-netlify': {
    ...
    coverImage: '/images/posts/automating-deployment-docusaurus-github-vercel-netlify.webp'
  },
  'ai-powered-website-automation-claude-mcp-server-guide': {
    ...
    coverImage: '/images/posts/ai-powered-website-automation-claude-mcp-server-guide.webp'
  },
  'mdx-blog-setup': {
    title: '使用 MDX 建立部落格',
    date: '2025-05-11',
    ...
    coverImage: '/images/mdx-blog-setup.webp'
  },
  ...
  'framer-motion-intro-guide': {
    ...
    coverImage: '/images/framer-motion-intro-guide.webp'
  },
  ...
  'typescript-best-practices': {
    ...
    coverImage: '/images/typescript-best-practices.webp'
  },
  ...
  'tailwind-css-tips': {
    ...
    coverImage: '/images/tailwind-css-tips.webp'
  },
  
  'mdx-blog-architecture-design-implementation': {
    title: 'MDX 部落格架構設計與實踐：從理論到實作的全方位指南',
    date: '2025-05-17',
    excerpt: '本文深入探討如何基於 Next.js App Router 構建一個現代化 MDX 部落格系統，特別著重於集中式元數據管理、雙層元件系統設計、TypeScript 型別安全保障，以及靜態生成與客戶端互動性的平衡。從架構選擇到實際部署，提供完整的技術藍圖和工作流程建議。',
    author: 'Ian Chou',
    tags: ['MDX', 'Next.js', 'React', 'TypeScript', '架構設計', '部落格系統'],
    coverImage: '/images/posts/mdx-blog-architecture-design-implementation.webp'
  },
  
  '2025-low-code-no-code-freelancing-complete-guide-90-day-plan': {
    title: '【2025完全指南】低程式碼/無程式碼外包接案入門：90天從零到專家',
    date: '2025-05-19',
    excerpt: '本文全面分析如何進入低程式碼/無程式碼外包市場，從平台選擇、技能培養到業務開發的各個層面提供實用指南。特別包含90天循序漸進啟動計劃與各平台練手項目建議，幫助讀者快速進入這個高回報的新興領域。',
    author: 'Ian Chou',
    tags: ['Low-Code', 'No-Code', '外包', '自由接案', 'Bubble', 'Webflow', 'AppSheet', '職涯發展'],
    coverImage: '/images/posts/2025-low-code-no-code-freelancing-complete-guide-90-day-plan.webp'
  }
};
