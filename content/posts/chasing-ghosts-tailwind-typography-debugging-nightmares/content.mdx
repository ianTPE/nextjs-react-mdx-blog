...
我直接改了 <code>tailwind.config</code>，希望能一勞永逸。但測試後發現，根本沒用。我也想過要不要直接卸載 Typography plugin，但... MDX 太好用了，Markdown 文章是主流，AI 能快速產生 markdown 和 React 組件。Typography 不能卸載。
