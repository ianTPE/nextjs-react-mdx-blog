...
朋友，你知道什麼是從天堂掉到地獄嗎？我知道，而且我剛從那裡爬出來。

Vibe Coding 是很讓人心情愉悅的開發方式。你懂的，就是那種「Claude，麻煩你幫我寫個響應式的表格」，然後看著程式碼像變魔術一樣出現在螢幕上。Tailwind 一把罩，AI 當助手，寫 code 就像在寫詩一樣優雅。我甚至開始覺得自己是個藝術家了。
...
其實 Model Context Protocol 的工具早就在那裡了。Playwright、Puppeteer、Browser-tools... 但當時的我就像個拿著 iPhone 12 還在找公共電話的原始人。
...
就這樣。<code>not-prose</code>。五個字母。解決了我三個月的噩夢。

## 終於可以睡個好覺：但故事還沒結束

找到答案的那個晚上，我睡了 12 個小時。醒來後，我把所有舊表格都翻出來測試。果然，加上 <code>not-prose</code> 後，世界恢復了正常。

我甚至想過要不要直接改 `tailwind.config`，一勞永逸。但測試後發現，這樣會破壞其他地方的樣式。我也想過要不要直接卸載 Typography plugin，但... MDX 太好用了，Markdown 文章是主流，AI 能快速產生 markdown 和 React 組件。Typography 不能卸載。
...
Tailwind 被一些人討厭不是沒有原因的。當你不理解它在背後做了什麼時，debug 就像在黑暗中摸索。但話說回來，哪個工具不是這樣呢？
...
*P.P.S. Claude Opus 4，如果你在看這篇文章，謝謝你救了我的命（和工作）。*