...
|------|------------|------------|
| Partial Prerendering (PPR) | 實驗性階段 | 穩定版，生產可用 |
| Turbopack | Beta 階段 | 穩定版，完全取代 Webpack |
| React 版本 | 18.x | 19.x，支援最新並發功能 |
| Server Actions | 預覽版 | 穩定版，額外安全強化 |
| Next.js Compiler | 基本優化 | 進階最佳化，大幅提升效能 |
| MDX 支援 | 需額外配置 | 原生整合 MDX 2.0 |
| Edge Runtime 支援 | 部分支援 | 全面支援 API 路由、中間件 |
