...
由於 <code>@line/create-liff-app</code> 可能還沒有預設使用最新版本，我們需要手動升級：
...
如果遇到相依性警告，可以使用 <code>--force</code> 旗標：
...
Next.js 15 支援 TypeScript 配置檔，讓我們將 <code>next.config.js</code> 改為 <code>next.config.ts</code>：
