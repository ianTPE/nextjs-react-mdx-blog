...
flowchart TD
    ...
    classDef phase1 fill:#667eea,color:white,stroke-width:2px
    classDef phase2 fill:#ff6b6b,color:white,stroke-width:2px
    classDef phase3 fill:#2ecc71,color:white,stroke-width:2px
    classDef phase4 fill:#f1c40f,color:black,stroke-width:2px
