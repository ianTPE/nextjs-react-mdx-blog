...
<MermaidDiagram chart={`
flowchart TD
%%{ init: { 'flowchart': { 'curve': 'linear', 'nodeSpacing': 15, 'rankSpacing': 30 }, 'themeVariables': { 'fontSize': '10px', 'fontFamily': 'system-ui' } } }%%
    subgraph "第一階段"
        A1["需求分析"] --> A2["技術選型"]
        A2 --> A3["架構設計"]
        A3 --> A4["專案結構"]
    ...
    classDef phase1 fill:#667eea,color:white,stroke-width:1px
    classDef phase2 fill:#ff6b6b,color:white,stroke-width:1px
    classDef phase3 fill:#2ecc71,color:white,stroke-width:1px
    classDef phase4 fill:#f1c40f,color:black,stroke-width:1px
...
- [GitHub 討論區](https://github.com/Aider-AI/aider/discussions)
