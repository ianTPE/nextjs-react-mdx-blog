...
description: "深入探討如何使用 Next.js 14/15、React 19、MDX、Tailwind CSS、Shadcn/UI 和 TypeScript 這套現代化技術堆棧，從零開始打造一個功能完整的一頁式電商網站。包含詳細實作步驟、最佳實踐和進階功能。"
date: "2025-06-08"
author: "Ian"
categories: ["Next.js", "React", "E-commerce", "Web Development"]
tags: ["Next.js", "React", "MDX", "Tailwind CSS", "Shadcn/UI", "TypeScript", "電商", "一頁式網站"]
image: "/images/posts/one-page-store-nextjs.jpg"
featured: true
---
