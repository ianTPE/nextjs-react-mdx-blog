...
npx shadcn@latest add separator skeleton toast
...
MDX 允許我們在 Markdown 中嵌入 JSX，這對於創建豐富的產品描述特別有用。建立產品 MDX 檔案 <code>src/content/products/wireless-headphones.mdx</code>：
...
整合所有元件，建立 <code>src/app/page.tsx</code>：
