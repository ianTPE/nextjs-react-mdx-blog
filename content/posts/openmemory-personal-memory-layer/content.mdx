...
<Alert type="info" title="專案亮點">
  OpenMemory 是一個開源的個人記憶層系統，為大型語言模型（LLMs）提供私有、可攜帶且開源的記憶管理解決方案，讓您完全掌控自己的數據。
</Alert>
...
<Alert type="tip" title="離線數據交換">
  使用 USB 隨身碟是交換 OpenMemory 記憶資料的最安全方式之一，完全避免網路傳輸風險。
</Alert>
...
**相關資源：**
- [OpenMemory GitHub 儲存庫](https://github.com/mem0/openmemory)
- [Memory Context Protocol (MCP) 規範](https://mcp.ai)
