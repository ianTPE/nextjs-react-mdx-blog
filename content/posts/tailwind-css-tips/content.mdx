...
Tailwind CSS 徹底改變了我們編寫 CSS 的方式。透過實用優先（utility-first）的方法，我們可以快速構建美觀的介面。本文將分享一些進階的 Tailwind CSS 技巧，幫助你更有效地使用這個強大的框架。

## 1. 自定義顏色系統

建立一致的顏色系統是設計的關鍵。Tailwind 允許你輕鬆自定義調色板：
...
<div className="max-w-sm rounded overflow-hidden shadow-lg">
  <img className="w-full" src="/img/card-top.jpg" alt="圖片" />
...
記住，Tailwind 的真正力量在於它的可定制性和靈活性。不要害怕根據專案需求進行調整和擴展。
